...
int main(int argc, char *argv[])
{
    ...
    TCLAP::ValueArg<double> grassOffset("o", "grass-offset", "Grass offset", false, 180, "grass-offset", cmd);
    ...
    TCLAP::ValueArg<std::string> json("j", "json", "JSON to load", false, "KickModelCollection.json", "json", cmd);
    TCLAP::SwitchArg gnuplot("g", "gnuplot", "gnuplot", cmd, false);
    TCLAP::SwitchArg json("j", "json", "json", cmd, false);
