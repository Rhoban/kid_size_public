...
std::string ArucoCalibration::getName()
{
  return "arucoCalibration";
}
...
// each detected tag
void ArucoCalibration::addEntry(std::vector<int>& indices, std::vector<std::pair<float, float>>& centers,
