...
private:
   ...
   */
  Leph::Spline buildStepTraj(double start, double period, double ampl, bool isHalf);
  Leph::Spline buildSmoothTraj(double start, double period, double ampl, bool isHalf);
