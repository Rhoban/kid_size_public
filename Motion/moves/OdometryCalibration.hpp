...
private:
   ...
   */
  std::vector<std::vector<Eigen::Vector3d>> _readTrajsPose;
  std::vector<std::vector<Leph::HumanoidFixedModel::SupportFoot>> _readTrajsSupport;
  std::vector<std::vector<Eigen::Vector3d>> _goalTrajsPose;
  std::vector<std::vector<Leph::HumanoidFixedModel::SupportFoot>> _goalTrajsSupport;
  std::vector<std::vector<Eigen::Vector4d, Eigen::aligned_allocator<Eigen::Vector4d>>> _walkTrajsOrder;
  std::vector<std::vector<double>> _walkTrajsPhase;
   ...
   */
  std::string cmdReferenceDisplacement(double dx, double dy, double da, bool setLast);
