...
KickPhilipp::KickPhilipp() : _filename(), _trajs(), _t(-1.0), _timeGain(1.0)
{
  // Initialize RhIO binding
  Move::initializeBinding();
  // Binding commands
  bind->bindFunc("kick_test_reset", "Reset KickPhilipp", &KickPhilipp::cmdReset, *this);
  bind->bindFunc("kick_test_start", "Start KickPhilipp", &KickPhilipp::cmdStart, *this);
  // Bind members
