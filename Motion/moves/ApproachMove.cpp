...
{
  bind->bindNew("expectedKick", expectedKick, RhIO::Bind::PushOnly)->defaultValue(expectedKick);
  bind->bindNew("kickRight", kickRight, RhIO::Bind::PushOnly)
      ->defaultValue(0.0)
      ->comment("Does next kick use right foot?");
  bind->bindNew("kickScore", kick_score, RhIO::Bind::PushOnly)
      ->defaultValue(0.0)
