...
PatchProvider::PatchProvider(const std::string & name)
  : Filter(name)
{
}
...
void PatchProvider::addPatches(const std::vector<cv::Rect> & rois,
...
void PatchProvider::addPatches(const std::vector<cv::RotatedRect> & rois,
                               const cv::Mat & roi_img,
                               const cv::Mat & src)
{
