...
const std::vector<double> &CompassProvider::getCompasses() const { return compasses; }
const std::vector<double> &CompassProvider::getDispersions() const { return dispersions; }
